...
public class MockDataGenerator {
    ...
    public static final String USERNAME_PLACEHOLDER = "${SAUCEDEMO_USERNAME}";
    public static final String PASSWORD_PLACEHOLDER = "${SAUCEDEMO_PASSWORD}";
    ...
    public static void ensureExcelData() {
        ...
        try (Workbook workbook = new XSSFWorkbook()) {
            ...
            writeHeader(sSmoke, "username", "password", "expected_url", "description");
                writeRow(sSmoke, 1, USERNAME_PLACEHOLDER, PASSWORD_PLACEHOLDER, "inventory.html", "Test 01 - Login tiêu chuẩn");
                writeRow(sSmoke, 2, "problem_user", PASSWORD_PLACEHOLDER, "inventory.html", "Test 02 - Login user hay lỗi");
                writeRow(sSmoke, 3, "performance_glitch_user", PASSWORD_PLACEHOLDER, "inventory.html",
            ...
            writeHeader(sNegative, "username", "password", "expected_error", "description");
                writeRow(sNegative, 1, USERNAME_PLACEHOLDER, "wrong_pass", "Username and password do not match",
                    "N01 - Sai password tiêu chuẩn");
                writeRow(sNegative, 2, "locked_out_user", PASSWORD_PLACEHOLDER, "locked out", "N02 - Tài khoản đã bị block");
                writeRow(sNegative, 3, "", PASSWORD_PLACEHOLDER, "Username is required", "N03 - Username bị bỏ trống");
                writeRow(sNegative, 4, USERNAME_PLACEHOLDER, "", "Password is required", "N04 - Password bị bỏ trống");
            ...
            String longString = "A".repeat(200);
                writeRow(sBoundary, 1, longString, PASSWORD_PLACEHOLDER, "Username and password do not match",
                    "B01 - Username nhập quá số lượng tối đa max-lenght kí tự > 200");
                writeRow(sBoundary, 2, USERNAME_PLACEHOLDER, longString, "Username and password do not match",
            ...
            writeRow(sBoundary, 3, "nguyen' OR '1' ='1", "pass", "Username and password do not match",
                ...
                writeRow(sBoundary, 4, "<script>alert(1)</script>", PASSWORD_PLACEHOLDER, "Username and password do not match",
