...
public class LoginExcelTest extends BaseTest implements ITest {
    ...
    public void ensureExcelFixtureExists() {
        MockDataGenerator.ensureExcelData();
    }
    ...
    public void testDynamicLogin(String sheetName, String usr, String pwd, String expected, String description) {
        ...
        String resolvedUsername = ConfigReader.resolveCredential(usr);
        String resolvedPassword = ConfigReader.resolveCredential(pwd);
